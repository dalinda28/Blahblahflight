<x-base-layout>
    ...
    <div>
        <div class="flex flex-col gap-8 max-w-7xl py-8 mx-auto">
            <div class="flex flex-col gap-2">
                <p class="italic">Last updated: June 06, 2022</p>
                ...
                <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
                    ...
                    been created with the help of the <a class="italic underline text-purple-700"
                        href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank">TermsFeed Privacy
                        Policy Generator</a>.</p>
                <h2 class="text-2xl font-semibold py-8">Interpretation and Definitions</h2>
                <h3 class="text-1xl text-purple-700 font-bold py-4">Interpretation</h3>
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-4">Definitions</h3>
                ...
                <ul class="list-disc ml-8">
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Blablaflight, 1 Rue du
                            Dahomey, 75011 Paris.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Blablaflight, accessible from <a
                                class="italic underline text-purple-700" href="http://www.blablaflight.com"
                                rel="external nofollow noopener" target="_blank">http://www.blablaflight.com</a></p>
                    </li>
                    <li>
                ...
                <h2 class="text-2xl font-semibold py-8">Collecting and Using Your Personal Data</h2>
                <h3 class="text-1xl text-purple-700 font-bold py-4">Types of Data Collected</h3>
                <h4 class="text-1xl font-semibold py-2 underline">Personal Data</h4>
                ...
                <h4 class="text-1xl font-semibold py-2 underline">Usage Data</h4>
                ...
                <h4 class="text-1xl font-semibold py-2 underline">Tracking Technologies and Cookies</h4>
                ...
                <ul class="list-disc ml-8">
                    ...
                    <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or
                        ...
                        change the settings for disabling, or deleting local shared objects?&quot; available at <a
                            class="italic underline text-purple-700"
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-4">Use of Your Personal Data</h3>
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-4">Retention of Your Personal Data</h3>
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-4">Transfer of Your Personal Data</h3>
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-4">Disclosure of Your Personal Data</h3>
                <h4 class="text-1xl font-semibold py-2 underline">Business Transactions</h4>
                ...
                <h4 class="text-1xl font-semibold py-2 underline">Law enforcement</h4>
                <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required
                    ...
                    agency).</p>
                <h4 class="text-1xl font-semibold py-2 underline">Other legal requirements</h4>
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-4">Security of Your Personal Data</h3>
                <p>The security of Your Personal Data is important to Us, but remember that no method of transmission
                    ...
                    security.</p>
                <h2 class="text-2xl font-semibold py-8">Children's Privacy</h2>
                ...
                <p>If We need to rely on consent as a legal basis for processing Your information and Your country
                    ...
                    information.</p>
                <h2 class="text-2xl font-semibold py-8">Links to Other Websites</h2>
                ...
                <h2 class="text-2xl font-semibold py-8">Changes to this Privacy Policy</h2>
                ...
                <h2 class="text-2xl font-semibold py-8">Contact Us</h2>
                <p>If you have any questions about this Privacy Policy, You can contact us:</p>
                <ul class="list-disc ml-8">
                    <li>
                        <p>By email: blablaflight@benjaminalerte.fr</p>
                    </li>
                    <li>
                        <p>By visiting this page on our website: <a href="{{ route('contact') }}"
                                rel="external nofollow noopener"
                                class="italic underline text-purple-700 italic">http://www.blablaflight.com/contact</a>
                        </p>
                    </li>
                </ul>
            </div>
