    ...
    <div class="bg-purple-100">
        <div class="flex flex-col gap-8 max-w-7xl py-8 mx-auto">
            <div class="flex flex-col gap-2">
                <h1 class="text-3xl font-semibold">Website Terms of use</h1>
            </div>
        </div>
    </div>
    <div>
        <div class="flex flex-col gap-8 max-w-7xl py-8 mx-auto">
            <div class="flex flex-col gap-2">
                ...
                <p>The Blablaflight website located at <a href="{{ route('main') }}"
                        class="italic underline text-purple-700 italic">http://www.blablaflight.com</a> is a copyrighted
                    work belonging to
                    Blablaflight. Certain features of the Site may be subject to additional guidelines, terms, or rules,
                    which will be posted on the Site in connection with such features.</p>
                ...
                <h2 class="text-2xl font-semibold py-8">Access to the Site</h2>

                <h3 class="text-1xl text-purple-700 font-bold py-2">Subject to these Terms.</h3>
                <p>Company grants you a non-transferable, non-exclusive,
                    revocable, limited license to access the Site solely for your own personal, noncommercial use.</p>

                <h3 class="text-1xl text-purple-700 font-bold py-2">Certain Restrictions.</h3>
                <p>The rights approved to you in these Terms are subject to the
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">No Support or Maintenance.</h3>
                <p>You agree that Company will have no obligation to provide
                ...
                <h2 class="text-2xl font-semibold py-8">User Content</h2>

                <h3 class="text-1xl text-purple-700 font-bold py-2">User Content.</h3>
                <p>"User Content" means any and all information and content that a user
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Acceptable Use Policy.</h3>
                <p>The following terms constitute our "Acceptable Use Policy":
                ...
                <h2 class="text-2xl font-semibold py-8">Third-Party Links & Ads; Other Users</h2>

                <h3 class="text-1xl text-purple-700 font-bold py-2">Third-Party Links & Ads.</h3>
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Other Users.</h3>
                <p>Each Site user is solely responsible for any and all of its own User
                ...
                <h2 class="text-2xl font-semibold py-8">Disclaimers</h2>
                ...
                <h2 class="text-2xl font-semibold py-8">Limitation on Liability</h2>
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Term and Termination.</h3>
                <p>Subject to this Section, these Terms will remain in full force
                ...
                <h2 class="text-2xl font-semibold py-8">Copyright Policy.</h2>
                ...
                <h2 class="text-2xl font-semibold py-8">General</h2>
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Applicability of Arbitration Agreement.</h3>
                <p>All claims and disputes in connection with
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Notice Requirement and Informal Dispute Resolution.
                </h3>
                <p>Before either party may seek
                    ...
                    be sent to: 1 Rue du Dahomey, 75011 Paris. After the Notice is received, you and the Company may
                    attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim
                    ...
                    to the arbitrator until after the arbitrator has determined the amount of the award to which either
                    party is entitled.</p>

                <h3 class="text-1xl text-purple-700 font-bold py-2">Arbitration Rules.</h3>
                <p>Arbitration shall be initiated through the American Arbitration
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Additional Rules for Non-Appearance Based
                    Arbitration.</h3>
                <p>If non-appearance based
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Time Limits.</h3>
                <p>If you or the Company pursues arbitration, the arbitration action must
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Authority of Arbitrator.</h3>
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Waiver of Jury Trial.</h3>
                <p>THE PARTIES HEREBY WAIVE THEIR CONSTITUTIONAL AND STATUTORY
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Waiver of Class or Consolidated Actions.</h3>
                <p>All claims and disputes within the scope of
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Confidentiality.</h3>
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Severability.</h3>
                <p>If any part or parts of this Arbitration Agreement are found under the
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Right to Waive.</h3>
                <p>Any or all of the rights and limitations set forth in this
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Survival of Agreement.</h3>
                <p>This Arbitration Agreement will survive the termination of
                    your relationship with Company.</p>

                <h3 class="text-1xl text-purple-700 font-bold py-2">Small Claims Court.</h3>
                <p>Nonetheless the foregoing, either you or the Company may bring
                    an individual action in small claims court.</p>

                <h3 class="text-1xl text-purple-700 font-bold py-2">Emergency Equitable Relief.</h3>
                <p>Anyhow the foregoing, either party may seek emergency
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Claims Not Subject to Arbitration.</h3>
                <p>Notwithstanding the foregoing, claims of defamation, violation of the Computer Fraud and Abuse Act,
                    and infringement or misappropriation of
                ...
                <h3 class="text-1xl text-purple-700 font-bold py-2">Electronic Communications.</h3>
                <p>The communications between you and Company use electronic
                    ...
                    electronically
                    satisfy any legal obligation that such communications would satisfy if it were be in a hard copy
                    writing.
                </p>

                <h3 class="text-1xl text-purple-700 font-bold py-2">Entire Terms.</h3>
                <p>These Terms constitute the entire agreement between you and us
                    ...
                    transfer in violation of the foregoing will be null and void. Company may freely assign these Terms.
                    The terms and conditions set forth in these Terms shall be binding upon assignees.</p>

                <h3 class="text-1xl text-purple-700 font-bold py-2">Your Privacy.</h3>
                <p>Please read our Privacy Policy.</p>

                <h3 class="text-1xl text-purple-700 font-bold py-2">Copyright/Trademark Information.</h3>
                <p>Copyright ©. All rights reserved. All trademarks,
                ...
                <h2 class="text-2xl font-semibold py-8">Contact Information</h2>

                <p>Address: 1 Rue du Dahomey, 75011 Paris</p>
                <p>Email: blablaflight@benjaminalerte.fr</p>
            </div>
        </div>
    </div>
</x-base-layout>
